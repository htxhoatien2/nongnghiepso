...
const CACHE_NAME = 'agrigis-pwa-v3.2.2';
...
const PRECACHE_ASSETS = [
  ...
  './data/data_embedded.js?v=3.2.2',
  './js/supabase_config.js?v=3.2.2',
  './js/data.js?v=3.2.2',
  './js/auth.js?v=3.2.2',
  './js/sync.js?v=3.2.2',
  './js/admin.js?v=3.2.2',
  './js/map.js?v=3.2.2',
  './js/records.js?v=3.2.2',
  './js/farmers.js?v=3.2.2',
  './js/analytics.js?v=3.2.2',
  './js/services.js?v=3.2.2',
  './js/purchasing.js?v=3.2.2',
  './js/app.js?v=3.2.2'
];
