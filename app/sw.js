...
const CACHE_NAME = 'agrigis-pwa-v3.2.9';

const PRECACHE_ASSETS = [
  './',
  './index.html',
  './manifest.json',
  './css/style.css?v=3.2.9',
  './data/data_embedded.js?v=3.2.9',
  './js/supabase_config.js?v=3.2.9',
  './js/data.js?v=3.2.9',
  './js/auth.js?v=3.2.9',
  './js/sync.js?v=3.2.9',
  './js/admin.js?v=3.2.9',
  './js/map.js?v=3.2.9',
  './js/records.js?v=3.2.9',
  './js/farmers.js?v=3.2.9',
  './js/analytics.js?v=3.2.9',
  './js/services.js?v=3.2.9',
  './js/purchasing.js?v=3.2.9',
  './js/app.js?v=3.2.9'
];
