...
const CACHE_NAME = 'agrigis-pwa-v3.1.7';

const PRECACHE_ASSETS = [
  './',
  './index.html',
  './manifest.json',
  './css/style.css?v=3.1.7',
  './data/data_embedded.js?v=3.1.7',
  './js/supabase_config.js?v=3.1.7',
  './js/data.js?v=3.1.7',
  './js/auth.js?v=3.1.7',
  './js/sync.js?v=3.1.7',
  './js/admin.js?v=3.1.7',
  './js/map.js?v=3.1.7',
  './js/records.js?v=3.1.7',
  './js/farmers.js?v=3.1.7',
  './js/analytics.js?v=3.1.7',
  './js/services.js?v=3.1.7',
  './js/purchasing.js?v=3.1.7',
  './js/app.js?v=3.1.6'
];
