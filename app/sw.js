...
const CACHE_NAME = 'agrigis-pwa-v2.8.5';

const PRECACHE_ASSETS = [
  './',
  './index.html',
  './manifest.json',
  './css/style.css?v=2.8.5',
  ...
  './js/admin.js?v=2.8.5',
  './js/map.js?v=2.8.5',
  './js/records.js?v=2.8.5',
  './js/farmers.js?v=2.8.5',
  './js/analytics.js?v=2.8.5',
  './js/services.js?v=2.8.5',
  './js/purchasing.js?v=2.8.5',
  './js/app.js?v=2.8.5'
];
